<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="/student/dashboard" class="btn btn-primary btn-lg btn-block btn-icon-split">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a class="nav-link" href="/student/testimoni"><i class="fas fa-fire"></i> <span>Testimoni</span></a></li>
                <li>
                <li class="dropdown active">
