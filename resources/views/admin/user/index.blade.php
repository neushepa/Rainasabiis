          ...
          <div class="col-12 col-md-12 col-lg-5">
            <div class="card profile-widget">
              <div class="profile-widget-header">
                <img alt="image" src="/assets/admin/img/avatar/avatar-1.png" class="rounded-circle profile-widget-picture">
              </div>
              <div class="profile-widget-description">
                <div class="profile-widget-name">{{ $pro->role }}<div class="text-muted d-inline font-weight-normal"><div class="slash"></div>{{ $pro->name }}</div>{!! $pro->bio !!}</div>
              </div>
                    ...
                    <div class="row">
                      <div class="form-group col-md-7 col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" value="{{ str_contains($url, 'edit') ? $pro->email : '' }}" required="" name="email">
                          </div>
                        <div class="invalid-feedback">
